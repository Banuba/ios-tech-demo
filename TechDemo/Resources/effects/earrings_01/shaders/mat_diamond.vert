...
BNB_DECLARE_SAMPLER_2D(18, 19, bnb_BONES);

#ifdef BNB_USE_UVMORPH

BNB_DECLARE_SAMPLER_2D(20, 21, bnb_UVMORPH_FISHEYE);
#endif

#ifdef GLFX_OCCLUSION
BNB_OUT(9) vec2 glfx_OCCLUSION_UV;
#endif

#ifdef BNB_USE_AUTOMORPH

BNB_DECLARE_SAMPLER_2D(22, 23, bnb_MORPH);
...
BNB_OUT(10) vec3 var_shadow_coord;
...
#ifdef GLFX_LIGHTING
#ifdef GLFX_TBN
BNB_OUT(5) vec3 var_t;
BNB_OUT(6) vec3 var_b;
#endif
BNB_OUT(7) vec3 var_n;
BNB_OUT(8) vec3 var_v;
#endif



BNB_OUT(2) vec3 var_cam_pos;
