...
#define COLOR				vec3 (1.0, 1.5, 1.8)
#define ALPHA				.15
#define REFRACT_INDEX		vec3 (2.45, 2.12, 2.67)
...
BNB_IN(2) vec3 var_cam_pos;
BNB_IN(3) float var_time;
BNB_IN(4) vec2 var_js_resolution;
...
void main()
{
    ...
    float step = 1.0;
    bnb_FragColor = 1.5 * pow( bnb_FragColor, vec4(step,step,step,1.0));
